d3.parcoords = function (config) {
  ...
  pc.updateAxes = function (animationTime) {
    ...
    g_data
      ...
      .attr(
        "transform",
        "translate(0,-10) rotate(" + __.dimensionTitleRotation + ")"
      );
    ...
    g_data
      ...
      .duration(animationTime)
      .text(function (d) {
        return dimensionPolarity(d, 0);
      })
      .attr(
        "transform",
        "translate(20,5) rotate(" + __.dimensionTitleRotation + ")"
      );
    g_data
      .select(".polarity2")
      .transition()
